            ...
            <MDBCard className="terms-card col-10">
              <MDBCardHeader className=" terms-headerCard py-2">
                ...
                <MDBRow className="term-backBtn">
                  <Link to={`/signin`}>
                    <MDBBtn className='terms-backBtn'>Back</MDBBtn>
                  </Link>
                </MDBRow>
              ...
              <MDBCardBody className='terms-cardBody'>
                ...
                <MDBRow className="mb-3">
                  ...
                  <MDBCol md="9" >You must be at least 18 years old to use the App. By creating an account, you represent and warrant that you are of legal age.
                  </MDBCol>   
                </MDBRow>
                <MDBRow className="mb-3">
                  <MDBCol md="1" className="mb-1">1.2 </MDBCol>
                  <MDBCol md="9">You are responsible for maintaining the confidentiality of your account credentials. You agree to notify us immediately of any unauthorized access or use of your account.
                  </MDBCol>
                </MDBRow>
                <MDBRow className="mb-3">
              ...
              <MDBRow className="mb-3">
                  <MDBCol md="1" className="mb-1">4.1 </MDBCol>
              ...
              <MDBRow className="mb-3">
                ...
                <MDBRow className="mb-2">
                  <MDBCol md="1" className="mb-1">5.2 </MDBCol>
                ...
                <MDBRow> <MDBTypography tag="h5" className="mb-3 " >Governing Law   </MDBTypography></MDBRow>
                <MDBRow className="mb-3">
                ...
                <MDBRow> <MDBTypography tag="h5" className="mb-3 " >Severability</MDBTypography></MDBRow>
