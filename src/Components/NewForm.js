  ...
  return (
    <div className='newFormBox'>
      ...
      <div className="newFormHdgBox">
            ...
            <span className='newFormSubHdg'>Where you can find a roommate that matches your preferences!</span><br/>
            <span className='newFormMsg'>First, please share some basic information about yourself, by completing this form and checking the options that apply. This will help provide the best matches. Thank you!</span> <br/>
      </div>
