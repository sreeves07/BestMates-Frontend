    ...
    return (
        <div className="messaging-nav">
            ...
            <div className='exit-profile-messaging-nav'>
                <div style={{paddingRight: "6px", color: "white"}}>Name</div>
                <img src={userImg} style={{borderRadius: "100%", border: "2px solid var(--mainColor)", marginRight: "5px"}} width="40px" alt="user" />
                <Link 
